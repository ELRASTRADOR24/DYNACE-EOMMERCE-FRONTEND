    ...
    <div className="app-container">
      ...
      <footer className="footer">
        <div className="footer-content">
          <span className="footer-brand">Dynace Global</span>
          <div className="footer-links">
            <a onClick={() => setCurrentTab('home')}>Boutique</a>
            <a onClick={() => setCurrentTab('reviews')}>Avis clients</a>
            <a onClick={() => setCurrentTab('checkout')}>Commander</a>
          </div>
        </div>
        <p className="footer-copy">&copy; {new Date().getFullYear()} Dynace Global. Tous droits réservés. Suppléments cellulaires et bien-être premium.</p>
      </footer>
    </div>
  );
}
